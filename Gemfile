...
gem 'killbill-deposit', github: 'killbill/killbill-deposit-ui', ref: 'master'
...
gem 'killbill-assets-ui', github: 'killbill/killbill-assets-ui', ref: 'master'
...
gem 'killbill-aviate', '1.1.0.pre.9'
